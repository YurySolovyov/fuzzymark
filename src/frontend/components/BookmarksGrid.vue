<template lang="html">
  <div
    ...
    <drag-drop-provider @dragEnd="onDragEnd">
      <div
        class="grid grid-cols-2 gap-4 min-[1280px]:grid-cols-3 min-[1720px]:grid-cols-4 min-[2160px]:grid-cols-5">
  ...
  <div
    v-else
    class="mx-auto w-11/12 pt-12 text-center text-(--input-text-color)">
    <h1 class="page-title">
