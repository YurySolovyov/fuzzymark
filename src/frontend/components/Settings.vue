      ...
      <section class="mt-10">
        ...
        <div class="flex flex-wrap">
          ...
          <settings-section
            ...
            @save="saveSetting"
            name="showDate"
            :active-value="activeShowDate"
            :values="showDateValues"
            :value-labels="showDateLabels" />
        </div>
      </section>
...
import browser from '../bookmarks/browser';
...
export default {
  ...
  computed: {
    showDateValues() {
      return browser() === 'firefox' ? ['none', 'created'] : ['none', 'created', 'lastUsed'];
    },
    showDateLabels() {
      return this.showDateValues.map((value) => {
        return {
          none: 'None',
          created: 'Created',
          lastUsed: 'Last Used',
    ...
    activeShowDate() {
      return this.showDateValues.includes(this.showDate) ? this.showDate : 'none';
    },
